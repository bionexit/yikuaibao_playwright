[原始页面地址](https://docs.ekuaibao.com/docs/open-api/invoice/get-entity-invoice)
    ...
    {  
        ...
        "items": [  
            {  
                ...
                "E_system_收票状态": "NORECEIVE",  
                "E_system_票据渠道": null,  
                "E_system_海外发票_title": "Clear Channel Outdoor",  
                "E_system_发票主体_图片": "MICOBillboardInvoice_WB-1732241630713-806.pdf",  
                "E_system_发票主体_方向": 0.0,  
                "E_system_发票主体_来源": "OVERSEAS_INVOICE",  
                "E_system_海外发票_日期": 1732118400000,  
                "E_system_海外发票_税额": {  
                    "rate": "7.1942",  
                    "foreign": "0.00",  
                    "sysRate": "7.1942",  
                ...
                "E_system_海外发票_currency": {  
                    ...
                    "version": 1,  
                    "active": true,  
                    "createTime": 1732244242076,  
                    "updateTime": 1732244242076,  
                    "name": "美元",  
                    "nameSpell": "MEIYUAN",  
                    "code": "USD",  
                    "corporationId": "",  
                ...
                "E_system_海外发票_lineItems": [  
                    {  
                        "items": [  
                            ...
                            {  
                                "key": "item_name",  
                                "value": "MICO Billboard 1st payment",  
                                "positions": [],  
                                "confidence": -1,  
                                "description": "名称",  
                                "value_in_pdf_page": 0  
                ...
                "E_system_发票主体_识别范围": [],  
                "E_system_票据来源_sourceEntityId": "ID01ExNK43JerY",  
                "E_system_海外发票_不计税金额": {  
                    "rate": "7.1942",  
                    "foreign": "0.00",  
                    "sysRate": "7.1942",  
                ...
                "active": false,  
                "updateTime": 1732241853312,  
                "createTime": 1732241647254,  
                "entityId": "system_海外发票",  
                "entity": {  
                    "operateSource": "WRITE",  
                    "operatorId": null,  
                    "pipeline": 1,  
                ...
                "flowForm": {  
                    ...
                    "state": "approving",  
                    "title": "对公付款单-老吴",  
                    "feeDate": 1732204800000,  
                    "payeeId": "ID01ExOg1RfaZg",  
                    "payMoney": {  
                        "standard": "5000.00",  
                        "standardUnit": "美元",  
                        "standardScale": 2,  
                    ...
                    "printCount": "0",  
                    "printState": "noPrint",  
                    "submitDate": 1732241851128,  
                    "attachments": [  
                        {  
                            "key": "扫描-1732241433066-635.pdf",  
                            "fileId": "ID01ExNzJqCaPA",  
                            "fileName": "扫描.pdf"  
                        }  
                    ],  
                    "expenseDate": 1732241358000,  
                    "submitterId": "djg8LshfUkfM00:ID01BVx4nP8uYf",  
                    "expenseMoney": {  
                        "standard": "5000.00",  
                        "standardUnit": "美元",  
                        "standardScale": 2,  
                    ...
                    "onlyOwnerPrint": false,  
                    "u_付款方式": "ID01CHmYBMLJCf",  
                    "u_分摊天数": "1",  
                    "u_分摊月份": "1",  
                    "u_开始时间": 1732204800000,  
                    "u_摊销金额": {  
                        "standard": "5000.00",  
                        "standardUnit": "美元",  
                        "standardScale": 2,  
                    ...
                    "u_是否预付": true,  
                    "u_结束时间": 1732204800000,  
                    "specificationId": "ID01CPBlWaHpeL:a8e0d0d1da488bda2dfdad73d41200aa94969609",  
                    "u_飞书架构1": "ID01CsStGEV8HZ",  
                    "writtenOffMoney": {  
                        "standard": "0.00",  
                        "standardUnit": "美元",  
                        "standardScale": 2,  
                    ...
                    "expenseDepartment": "djg8LshfUkfM00:ID01EjF1OsAN5Y",  
                    "u_供应商名字": "Clear Channel Outdoor LLC",  
                    "u_准确性校验": "正确",  
                    "u_提交人部门": "djg8LshfUkfM00:ID01EjF1OsAN5Y",  
                    "u_新建供应商": true,  
                    "u_是否预付款": "ID01CPU651i0j5",  
                    "u_本位币币种": "ID01D7X1skcg47",  
                    "voucherCreateTime": 0,  
                    "optionalPayeeByZero": true,  
                    "preApprovedNodeName": "直属领导",  
                    "preNodeApprovedTime": 1732242180141,  
                    "u_合同起始日期": {  
                        "end": 1732204800000,  
                        "start": 1732204800000  
                    },  
                    "u_最晚付款时间": 1732723200000,  
                    "u_特殊付款备注": "",  
                    "legalEntityMultiCurrency": "ID01BIcTc5Qurd",  
                    "ownerAndApproverPrintNodeFlag": false,  
                    "u_是否核销预付款开关": false  
                },  
                "flowId": "ID01ExOg1RiSCa"  
            }  
        ]  
    }  
